    ...
    <main class="w-full parallax  sc1">
      ...
      <section class="flex flex-col items-center justify-center relative bg-red-700 py-20 md:py-36 px-4">
        ...
        <h2 class="text-4xl md:text-6xl font-bold playwrite-gb-s-uniquifier xl:text-6xl text-white mb-8 md:mb-16">Hộp
          mừng cưới</h2>
        <div class="flex flex-col gap-6 w-full md:w-2/3 md:flex-row">
          <!-- Mừng cưới đến cô dâu -->
          <div
            class="bg-white shadow-lg rounded-lg w-full md:px-10 py-8 md:py-10 xl:py-20 flex flex-col items-center text-center">
            <div
            ...
            <img src="/qr1.jpg" alt="QR code cô dâu" class="w-48 md:w-64 mb-4" />
          </div>
          ...
          <div
            ...
            <img src="/qr2.jpg" alt="QR code chú rể" class="w-48 md:w-64 mb-4" />
          </div>
        </div>
      </section>
    </main>
...
const toggleAudio = () => {
  ...
  isPlaying.value = !isPlaying.value; // Đảo ngược trạng thái
};
